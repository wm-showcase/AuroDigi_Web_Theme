...
--------
To clone the AuroDigi_Web_Theme repository, use git clone:

<pre>
 git clone https://github.com/wavemaker/AuroDigi_Web_Theme.git
 cd AuroDigi_Web_Theme
 npm install
</pre>
...
Build
--------
To build the WaveMaker Theme run the below command from AuroDigi_Web_Theme directory
